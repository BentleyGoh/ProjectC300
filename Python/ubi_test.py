...
TOKEN = "BBFF-JYsLwK5FlgETq3yGHzaNo0aQknOe43"  # Put your TOKEN here
DEVICE_LABEL = "machine"  # Put your device label here 
VARIABLE_LABEL_1 = "temperature"  # Put your first variable label here
VARIABLE_LABEL_2 = "gas level"  # Put your second variable label here
VARIABLE_LABEL_3 = "position"  # Put your third variable label here
